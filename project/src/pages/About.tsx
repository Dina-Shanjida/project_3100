          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-6">
                TechNova was founded with a simple but powerful mission: to make technology 
                accessible and understandable for everyone. We believe that in our rapidly 
                evolving digital world, staying informed about technology isn't just beneficial—it's essential.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                Our team of experienced journalists and tech experts work tirelessly to bring 
                you the most important stories, breaking news, and in-depth analysis from the 
                world of technology. From artificial intelligence and cybersecurity to the latest 
                gadgets and programming trends, we cover it all.
              </p>
              <p className="text-lg text-gray-600">
                We're committed to providing accurate, unbiased reporting that helps our readers 
                make informed decisions about the technology that shapes their lives.
              </p>
            </motion.div>
